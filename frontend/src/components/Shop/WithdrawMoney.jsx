                  ...
                  <div>
                    <div className="800px:flex w-full justify-between items-center">
                      <div className="800px:w-[50%]">
                        ...
                        <h5>Tên chủ tài khoản: {seller?.withdrawMethod.bankName}</h5>
                      </div>
                      <div className="800px:w-[50%]">
                        <AiOutlineDelete
                          size={25}
                    ...
                    <br />
                    <h4>Số dư khả dụng: {seller?.availableBalance}$</h4>
                    <br />
                    <div className="800px:flex w-full items-center">
                      <input
                        ...
                        className="800px:w-[200px] w-[full] border 800px:mr-3 p-1 rounded"
                      />
                      <div
